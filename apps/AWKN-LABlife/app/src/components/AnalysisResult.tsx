...
import type { AnalysisData } from '../types/lifekline';
...
const Card = ({ title, iconName, content, score, colorClass, extraBadges }: any) => {
  ...
  return (
    <div className="bg-surface-container p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow flex flex-col h-full relative overflow-hidden">
      <div className={`flex items-center justify-between mb-3 ${colorClass}`}>
        ...
        <Icon name="star" size={16} className="opacity-50" />
      </div>
